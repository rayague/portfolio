...
const Navbar = () => {
  ...
  const navItems = [
    { href: "/", label: "Home", icon: faHome, color: "from-blue-500 to-blue-600" },
        ...
        <div className="w-full">
          <div className="flex items-center justify-between w-full">
            ...
            <motion.button
              ...
              className="md:hidden flex items-center justify-center w-10 h-10 bg-gradient-to-r from-slate-700 to-slate-800 hover:from-slate-600 hover:to-slate-700 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl group"
            ...
            <div className="hidden sm:flex items-center space-x-2">
              {["from-blue-400 to-purple-500", "from-purple-400 to-pink-500", "from-pink-400 to-red-500"].map((gradient, i) => (
                <motion.div
                  key={i}
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-white/10">
                <h2 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Menu</h2>
                <motion.button
                  onClick={closeMobileMenu}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-white/10">
                <div className="flex items-center justify-center space-x-3">
                  ...
                  />
                  <span className="text-sm text-slate-400">Navigation rapide</span>
                  <motion.div
